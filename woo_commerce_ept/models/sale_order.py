...
class SaleOrder(models.Model):
    ...
    def get_order_data_from_specific_ids(self, params, woo_instance, order_ids):
        ...
        order_queue_ids = self.create_woo_order_data_queue(woo_instance, order_data_list).ids
    ...
    def get_order_link(self):
        ...
        @author: Nilam Kubavat on Date 14-July-2022.
        """
        self.ensure_one()
    ...
    def apply_woo_taxes(self, taxes, tax_included, woo_instance):
        ...
        for tax in taxes:
            ...
            if tax_included:
                ...
                name = "%s (%s %% excluded)" % (title, rate)
            woo_tax = tax_obj.search([('name', '=ilike', name),
    ...
    def create_woo_orders(self, queue_lines, common_log_book_id):
        ...
        for queue_line in queue_lines:
            ...
            woo_operation = 'import_completed_orders' if order_data.get('status') == 'completed' else \
