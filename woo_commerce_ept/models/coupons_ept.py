...
class WooCouponEpt(models.Model):
    ...
    def create_or_update_woo_coupon(self, coupon, queue_line, instance, common_log_book_id):
        """
        This method searches for the coupon, prepares data for it and updates or creates from the data.
        @param coupon: Data of a coupon.
        @param queue_line: Queue line.
        @param instance: Record of the instance.
        @param common_log_book_id: Record of the Log book.
        @author: Maulik Barad on Date 10-Nov-2020.
        """
    ...
    def create_or_write_coupon(self, queue_lines, common_log_book_id=False):
        ...
        for queue_line in queue_lines:
            ...
            woo_coupon = self.create_or_update_woo_coupon(coupon, queue_line, instance, common_log_book_id)
            if not woo_coupon:
                continue
    ...
    def woo_import_all_coupons(self, wc_api, page, common_log_book_id, model_id):
        """
        ...
        result = self.check_woocommerce_response(res, "Import Coupons", model_id, common_log_book_id)
    ...
    def sync_woo_coupons(self, instance, common_log_book_id, model_id):
        ...
        results = self.check_woocommerce_response(res, "Import Coupons", model_id, common_log_book_id)
    ...
    @api.model
    def export_coupons(self, instance, common_log_book_id, model_id):
        """
        ...
        try:
            ...
            raise UserError(_("Something went wrong while Exporting Coupons.\n\nPlease Check your Connection and "
                              "Instance Configuration.\n\n" + str(error)))
        response = self.check_woocommerce_response(res, "Export Coupons", model_id, common_log_book_id)
    ...
    def update_woo_coupons(self, instances, common_log_book_id, model_id):
        """
        ...
        for instance in instances:
            ...
            results = self.check_woocommerce_response(res, "Update Coupon", model_id, common_log_book_id)
